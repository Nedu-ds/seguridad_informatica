...
def lectura_archivos(nombre_archivo_csv):
    ...
    nombre_archivo_csv = nombre_archivo_csv.replace(".csv",".txt")
    print(nombre_archivo_csv)
    path_archivo = "D:/Accesos/Archivo_LDAP_Correo/"+ nombre_archivo_csv
    print(path_archivo)
...
def lectura_correos_Ingreso(nombre_archivo):
    ...
    path_archivo = 'D:/Accesos/Ingreso de Personal/'+nombre_archivo
...
def crear_excel(informacion,nombre,tipo):
    ...
    #path_archivo = filedialog.askdirectory()
    if tipo == "ingreso":
        path_archivo = 'D:/Accesos/Reportes Ingreso de Personal/'
    else:
        path_archivo = 'D:/Accesos/Reportes Baja de Personal/'
    arch_corr = os.listdir(path_archivo)
